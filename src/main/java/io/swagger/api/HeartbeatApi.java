...
public interface HeartbeatApi {
    ...
    @ApiOperation(value = "gives developer information about the health of the system. [uses /agency hook for the Agency endpoint]", nickname = "getHeartbeat", notes = "", response = String.class, tags={ "developers", })
    @ApiResponses(value = { 
