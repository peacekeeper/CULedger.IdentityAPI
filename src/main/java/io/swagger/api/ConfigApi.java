...
public interface ConfigApi {
    ...
    @ApiOperation(value = "get Value of configuration setting with name valueName.", nickname = "getConfigValue", notes = "", response = String.class, tags={ "developers", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "provides the basic configuration information about the system.", nickname = "listConfigSettings", notes = "", response = CULedgerKeyPair.class, responseContainer = "List", tags={ "developers", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "get Value of configuration setting with name valueName.", nickname = "setConfigValue", notes = "", response = String.class, tags={ "developers", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = String.class) })
    @RequestMapping(value = "/config/{valueName}",
        produces = { "application/json" }, 
